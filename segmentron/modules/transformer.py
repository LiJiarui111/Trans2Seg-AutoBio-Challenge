...
class Attention_Decoder(nn.Module):
    ...
    def forward(self, q, x):
        # print("hahahahahahahahahah", q.shape)
...
# TODO change the number of class here (when this module is called, 
# this parameter would haven't been assign so the default number will be used)
class VisionTransformer(nn.Module):
    """ Vision Transformer with support for patch or hybrid CNN input stage
    """
    def __init__(self, input_dim=2048, embed_dim=768, depth=12, num_patches=32*32, nclass=21,
                 decoder_feat_HxW=1024, num_heads=21, mlp_ratio=4., qkv_bias=False, qk_scale=None,
